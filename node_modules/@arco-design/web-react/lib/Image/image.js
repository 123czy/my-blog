...
function Image(baseProps, ref) {
    ...
    var _lazyload = lazyload && !dom_1.isServerRendering;
    var _f = (0, useImageStatus_1.default)('beforeLoad'), isLoading = _f.isLoading, isError = _f.isError, isLoaded = _f.isLoaded, setStatus = _f.setStatus, isLazyLoad = _f.isLazyLoad;
    ...
    var inView = (0, useInView_1.default)(__assign({ target: refImg.current, hasInView: !_lazyload }, intersectionInitOptions)).inView;
