...
function Table(baseProps, ref) {
    ...
    var _p = __read((0, useStickyClassNames_1.default)(groupColumns, flattenColumns, prefixCls), 2), groupStickyClassNames = _p[0], stickyClassNames = _p[1];
    var _q = (0, useSorter_1.default)(flattenColumns, defaultSorters), currentSorter = _q.currentSorter, activeSorters = _q.activeSorters, getNextActiveSorters = _q.getNextActiveSorters, updateStateSorters = _q.updateStateSorters;
