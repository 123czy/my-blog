...
var SelectView = function (props, ref) {
    var _a;
    var prefixCls = props.prefixCls, style = props.style, className = props.className, addBefore = props.addBefore, rtl = props.rtl, renderView = props.renderView, rest = __rest(props, ["prefixCls", "style", "className", "addBefore", "rtl", "renderView"]);
    ...
    var eleCoreSelectView = (react_1.default.createElement(CoreSelectView, __assign({}, props, { ref: refCoreSelectView, style: needWrapper ? undefined : propsAppliedToRoot.style, className: needWrapper ? undefined : propsAppliedToRoot.className, htmlDataAttributes: needWrapper ? {} : htmlDataAttributes })));
